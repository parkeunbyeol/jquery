var DATA = [
  { user: '김자바', message: '오늘도 행복 #커피한잔', created_at: '2019-01-03 12:30:20' },
  { user: '박자바', message: '개발은 즐거워 #pair #programming', created_at: '2019-01-04 18:30:20' },
  { user: '맹자바', message: '열심히 일하자 #work #hard', created_at: '2019-01-05 07:30:20' },
  { user: '이자바', message: '배고프면 과학적으로 머리가 맑아지려나', created_at: '2015-01-03 12:30:20' },
  { user: '홍자바', message: '하루하루 재미있기', created_at: '2019-01-04 18:30:20' }
];

var randomUser = ['김자바', '박자바', '맹자바', '이자바', '홍자바', '자바'];
var randomMessage = [
